...
extern const uint8_t FreeSerif9pt7bBitmaps[]; // Bitmap verileri
extern const GFXglyph FreeSerif9pt7bGlyphs[]; // Glif bilgileri
extern const GFXfont FreeSerif9pt7b;         // Font yapısı
