...
extern const uint8_t FreeSansBold12pt7bBitmaps[]; // Bitmap verileri
extern const GFXglyph FreeSansBold12pt7bGlyphs[]; // Glif bilgileri
extern const GFXfont FreeSansBold12pt7b;         // Font yapısı
