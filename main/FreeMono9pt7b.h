...
extern const uint8_t FreeMono9pt7bBitmaps[]; // Bitmap verileri
extern const GFXglyph FreeMono9pt7bGlyphs[]; // Glif bilgileri
extern const GFXfont FreeMono9pt7b;         // Font yapısı
