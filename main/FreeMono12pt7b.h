...
extern const uint8_t FreeMono12pt7bBitmaps[]; // Bitmap verileri
extern const GFXglyph FreeMono12pt7bGlyphs[]; // Glif bilgileri
extern const GFXfont FreeMono12pt7b;         // Font yapısı
